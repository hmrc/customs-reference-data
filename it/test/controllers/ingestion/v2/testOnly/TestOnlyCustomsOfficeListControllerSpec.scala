...
class TestOnlyCustomsOfficeListControllerSpec extends TestOnlyIngestionControllerSpec {

  override val validGzipFile: String = "/reference/v2/customs_offices.xml.gz"
  override val validXmlFile: String  = "/reference/v2/customs_offices.xml"

  private val url = s"$baseUrl/customs-reference-data/test-only/customs-office-lists"

  "v2 customs offices test-only ingestion endpoint" - {
